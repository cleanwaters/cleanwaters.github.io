export const aboutUsData = {
  ...
  teamList: [
    ...
    {
      name: 'Will Jefferies - Senior Advisor',
    ...
    // 3
    {
      name: 'Armen Arakelian - Senior Advisor',
      image: '/images/aboutus/about_us_section_one.png',
      description:
        'Start-up entrepreneur with experience across pacific trade, China im/export and commercial operations, specialising in fine foods, agribusiness and sustainability within investment, wholesale and retail trade. Armen is a long-standing volunteer with RFS and operates Back To The Bush, a non-profit social enterprise..',
    },
    // 4
    {
    ...
    // 7
    {
      ...
      description:
        'Bijang is an Indigenous artist, model and actor who currently works as an ambassador for Myer. He has previously worked with well-known brands such as Bonds, Billabong and Target. Bijang feels most comfortable in the water, growing up at Fingal Beach and nearby the Tweed River.',
    },
    // 8
    {
