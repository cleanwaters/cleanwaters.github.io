...
export const aboutUsData = {
    subTitle: "We're a team dedicated to clean water solutions for those who need it most",
    sectionOne: {
        details: [
            'As the principal of Back to the Bush, a non-profit social enterprise involved in environmental conservation and community philanthropy, and a veteran volunteer fire fighter, it is a privilege and an honour to have been appointed as the Head of Social Impact and spearhead the corporate and investment affairs of Clean Waters.',
            'It gives me great pleasure to present you with an opportunity that will make a difference to the lives of thousands across regional Australia, and secure sustainable water for hundreds of communities and projects across the nation. We are proud to represent WaterGen and their patented world-leading technology in this capacity in Australia.',
