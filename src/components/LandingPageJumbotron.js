...
export default function LandinPageJumbotron({ video, button, paragraph, title="Clean Waters" }){
    return (
        <StyledJumbotron className='jumbotron jumbotron-fluid' style={{ background: 'black' }}>
