                        ...
                        <StyledCWCard className="card my-4">
                            <div className="card-body">
                                <div style={{minHeight: '25em'}}>
                                    <StyledP36 className="text_bold text_color_primary my-4" style={{ fontSize: '36px', color: '#00C0FF' }} >{item.title}</StyledP36>
                                    <img style={{ padding: '10px', maxHeight: '18em'}} src={process.env.PUBLIC_URL + `/images/${item.image}`} loading="lazy" className="card-img-top" />
                                </div>
