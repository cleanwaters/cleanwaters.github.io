...
const ButtonMailto = ({ mailto, label }) => {
    return (
        <Link
            style={{
                position:'relative', top:'45%', width:'60%', height:'25%',
                borderRadius:'50px', backgroundColor:'#0170B9'
            }} 
            to='#'
            onClick={(e) => {
...
export function Contact(){
    ...
    function sendEmail(e){
        ...
        emailjs.sendForm('clean_water', 'template_xaxgdpi', form.current, 'user_0IR6b2RHWqOPPeblkysxV')
        .then((result) => {
